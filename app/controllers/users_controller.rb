...
class UsersController < ApplicationController
  def show
    ...
    @total_by_recipe_with_fuda = retrieve_total_by_recipe_with_fuda(user)
  ...
  def retrieve_total_by_recipe_with_fuda(user)
    res_by_recipe_with_fuda = user.tantous.group_by_shizai.order_by_shizai.with_fuda.count
    rares_by_recipe_with_fuda = user.tantous.rare_katana.group_by_shizai.order_by_shizai.with_fuda.count
  ...
  def retrieve_total_by_recipe_without_fuda(user)
    res_by_recipe_without_fuda = user.tantous.group_by_shizai.order_by_shizai.without_fuda.count
    rares_by_recipe_without_fuda = user.tantous.rare_katana.group_by_shizai.order_by_shizai.without_fuda.count
